      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-FK5XZ3HO.js"), import("./default.fragment-W4XJ5WWA.js")]);
          } else {
            await Promise.all([import("./default.vertex-ESKBZMT2.js"), import("./default.fragment-TNUAE3EL.js")]);
          }
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-ZUZYFAGJ.js"), import("./pbr.fragment-ABOLVFLS.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-CJIUZUUX.js"), import("./pbr.fragment-XD7PRMQB.js")]);
        }
        this._shadersLoaded = true;
      }
    }, engine);
...
//# sourceMappingURL=chunk-G7YYWJY7.js.map
